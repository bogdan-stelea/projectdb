-- ========================================
-- Enhanced Audit Triggers Using CLIENT_IDENTIFIER
-- This approach works with connection pooling
-- ========================================

-- 1. UPDATE STUDENT TABLE TRIGGERS
-- ========================================
...
BEGIN
    -- Get the client identifier set by the application
    -- If not set, fall back to database user
...
-- 2. UPDATE INSTRUCTOR TABLE TRIGGERS
-- ========================================
...
-- 3. UPDATE ENROLLMENT TABLE TRIGGERS
-- ========================================
